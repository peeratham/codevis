ForceBubble = function(listener) {
  ...
  updateNodes = function() {
    ...
    .attr("class", function(d){return d.className == 'function' ? "bubble-node-func" : "bubble-node" })
  ...
  click = function(d) {
    ...
    if(listener){
      listener({name: d.name, className:d.className, line:d.line});
    }
